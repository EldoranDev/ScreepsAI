 ...
 * @returns {null|StructureContainer}
 */
Source.prototype.getContainer = function getContainer() {
    const result = this.pos.findInRange(FIND_STRUCTURES, 1, {
        /** @param {Structure} s */
        filter: (s) => s.structureType === STRUCTURE_CONTAINER,
    });

    this._contaier = result.length ? result[0] : null;
 ...
 * @returns {boolean}
 */
Source.prototype.hasContainer = function hasContainer() {
    this._hasContainer = this.getContainer() !== null;

    return this._hasContainer;
};

Source.prototype.isBuildingContainer = function isBuildingContainer() {
...
Source.prototype.buildContainer = function buildContainer() {
